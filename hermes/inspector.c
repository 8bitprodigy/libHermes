...
void  Hermes_Inspector_Create(void)
{
    inspector.window =  Hermes_CreateWindow(0, UI_WINDOW_INSPECTOR, "Inspector", 0, 0);
...
void  Hermes_Inspector_Update(void)
{
...
void  Hermes_Inspector_SetFocusedWindow(UIWindow *window)
{

#ifndef HERMES_WINDOW_H_
#define HERMES_WINDOW_H_
...
UIWindow *Hermes_CreateWindow(UIWindow *owner, uint32_t flags, const char *cTitle, int _width,
                             int _height);
